    ...
    public function run()
    {
        DB::table('users')->insert([
            [
                ...
                'password' => Hash::make('19490823197603200'),
                'role_id' => 1
            ],[
                'name' => 'Prof.Dr.Ir.Joko Lianot Buliali, M.Sc',
                ...
                'name' => 'Dr.Ir. Raden Venantius Hari Ginardi, M.Sc.',
                'username' => '196505181992031003',
                'password' => Hash::make('196505181992031003'),
                'role_id' => 1
            ],[
                'name' => 'Wahyu Saudi, S.Kom, MM.M.Kom',
                ...
                'name' => 'Umi Laili Yuhana,S.Kom,M.Kom',
                'username' => '197906262005012002',
                'password' => Hash::make('197906262005012002'),
                'role_id' => 1
            ],[
                'name' => 'Tohari Ahmad,S.Kom.,MIT',
                'username' => '197505252003121002',
                'password' => Hash::make('197505252003121002'),
                'role_id' => 1
            ],[
                'name' => 'Royyana Muslim Ijtihadie,S.Kom.,M.Kom.',
                'username' => '197708242006041001',
                'password' => Hash::make('197708242006041001'),
                'role_id' => 1
            ],[
                ...
                'name' => 'Waskitho Wibisono,S.Kom.,M.Eng.',
                ...
                'name' => 'Darlis Herumurti,S.Kom., M.Kom.',
                'username' => '197712172003121001',
                'password' => Hash::make('197712172003121001'),
                'role_id' => 1
            ],[
                'name' => 'Radityo Anggoro, S.Kom,M.Sc',
